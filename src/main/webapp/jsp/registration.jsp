            ...
            <form name="registrationForm" method="post" action="controller" class="needs-validation" novalidate>
                ...
                <div class="mb-3">
                    <div class="form-group">
                        <label for="validationTooltip01" class="validationTooltip"><fmt:message key="Label.Login"/></label>
                ...
                <div class="mb-3">
                    <div class="form-group">
                        <label for="validationTooltip02" class="validationTooltip"><fmt:message key="Label.Password"/></label>
                ...
                <div class="mb-3">
                    <div class="form-group">
                        <label for="validationTooltip03" class="validationTooltip"><fmt:message key="Label.Confirm"/></label>
