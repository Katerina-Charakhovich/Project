                ...
                <div class="validation">${errorData}</div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select" name="gender" id="inputGroupSelect02">
                            ...
                            <option value="<fmt:message key="Select.Male"/>"><fmt:message key="Select.Male"/></option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select" name="country" id="inputGroupSelect01">
                            ...
                            <option value="<fmt:message key="Select.ITALY"/>"><fmt:message key="Select.ITALY"/></option>
                            ...
                            <option value="<fmt:message key="Select.SPAIN"/>"><fmt:message key="Select.SPAIN"/></option>
                    ...
                    <div class="mb-3">
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1" class="profileType"><fmt:message key="Label.About_me"/></label>
